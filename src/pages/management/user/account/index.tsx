			...
			<TabsList>
				<TabsTrigger value="1">
					<div className="flex items-center">
						...
						<span>{t("management.user.account.tabs.general")}</span>
					</div>
				</TabsTrigger>
				<TabsTrigger value="2">
					<div className="flex items-center">
						<Icon icon="solar:bell-bing-bold-duotone" size={24} className="mr-2" />
						<span>{t("management.user.account.tabs.notifications")}</span>
					</div>
				</TabsTrigger>
				<TabsTrigger value="3">
					<div className="flex items-center">
						<Icon icon="solar:key-minimalistic-square-3-bold-duotone" size={24} className="mr-2" />
						<span>{t("management.user.account.tabs.security")}</span>
					</div>
				</TabsTrigger>
			</TabsList>
			<TabsContent value="1">
